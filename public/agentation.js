...
`)}
    ...
    }`].join(""),document.head.appendChild(e)};sx()});var cx=so(()=>{var Fp=_t(Nn()),jp=_t(Yh());Wp();var Hp=["localhost","127.0.0.1",""].includes(window.location.hostname),ax=Hp||/[?#&]annotate/.test(window.location.href);if(ax&&!document.getElementById("agentation-root")){let e=document.createElement("div");e.id="agentation-root",document.body.appendChild(e),(0,jp.createRoot)(e).render(Fp.default.createElement(Ap,{endpoint:Hp?"http://localhost:4747":void 0}))}});cx();})();
